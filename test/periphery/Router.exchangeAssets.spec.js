...
describe("Router contract", ()=> {
    ...
    describe("Exchange assets", () => {  
        async function deployRouterFixture() {
            ...
            console.log('============ balToken address: =============', balToken.address);
            console.log('============ aaveToken address: =============', aaveToken.address);
            console.log('============ daiToken address: =============', daiToken.address);


            console.log('---- PATH iz ----', path);
        ...
        it.only("should swap an exact amount of input tokens in exchange for a minimum amount of output tokens", async() => {
            ...
            const balTokenBalanceBeforeTrade = ethers.utils.formatUnits(await balToken.balanceOf(trader.address));
            console.log('----- balTokenBalanceBeforeTrade -----', balTokenBalanceBeforeTrade);
            const aaveTokenBalanceBeforeTrade = ethers.utils.formatUnits(await aaveToken.balanceOf(trader.address));
            console.log('----- aaveTokenBalanceBeforeTrade -----', aaveTokenBalanceBeforeTrade);
            const daiTokenBalanceBeforeTrade = ethers.utils.formatUnits(await daiToken.balanceOf(trader.address));
            console.log('----- daiTokenBalanceBeforeTrade -----', daiTokenBalanceBeforeTrade);
